...
lf_plt <- lf_all |>
  mutate(date = ym(paste(Year, month)),           # create date var
...
head(lf_plt, 8) # examine first 8 rows
...
- `dygraphs` and `hcharts` are useful tools for understnading, managing, and curating time series data.

- HW 4 was due Wednesday, 10/12

  - Grace period in effect.  TAs are available to assist if you have questions on Friday.
  
  - Reminder: I am out of town and not answering email from 10/14 to 10/16
...
**You may submit an 'Engagement Question or Comment' about Week 7 lectures until Thursday, 10/13, at midnight on Blackboard.**
]
