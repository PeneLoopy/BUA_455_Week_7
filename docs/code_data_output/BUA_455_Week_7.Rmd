...
- Quiz 1 is now graded
  ...
  - 65%: Submitted Markdown File
  
  - 30%: Blackboard Answers 
  
  - 5%: Submitted .csv file (2%) + Submitted .png file (3%)
...
- Groups of 6 will be determined and posted (Hopefully by Friday)
...
- **Groups assigned by March 3rd (hopefully)**
  
- **Tue. March 21st at 5:00 PM:** Draft Proposals Due (2 - 3 paragraphs) - NO GRACE PERIOD

- **Thu. March 23rd:** 
  - Groups should come with questions and be prepared to answer my questions (5 min. per groups)

-   **Mon. March 27th:**  Final Proposals Due

-   **Fri. March 31st:**  HW 5 - Part 1 Due

-   **Tue. April 4th:**  Quiz 2

-   **Thu. April 6th:**  NO CLASS
...
- SIDE NOTE: If tow chunks are given the EXACT SAME name, e.g. `importing data`, document will not knit.
...
getSymbols("NFLX", from = "2013-01-01", to = "2023-02-24")
getSymbols("AMZN", from = "2013-01-01", to = "2023-02-24")
getSymbols("DIS", from = "2013-01-01", to = "2023-02-24")
...
***PointSolutions Session ID: bua455s23***
...
1.  Use provided exampled of `getSymbols` code to write code to import the stock time series for Apple (`AAPL`)
    - Use these dates: from = "2015-01-01", to = "2023-02-01"
...
- HW 4 is due Wednesday, 3/1

  - Grace period in effect.  TAs and I are available to assist if you have questions.
