---
title: "Week 7 and 8 - Time Series, Data Formats, Output Formats, Project Intro"
...
- **Groups assigned by Monday (10/16) at the latest**

- **Tue. 10/24:** NO CLASS
  
- **Thu. 10/26 at 5:00 PM:** Draft Proposals Due (2 - 3 paragraphs) - NO GRACE PERIOD

- **Tue. 10/31: Proposal Meetings** 
  - Groups should come with questions and be prepared to answer my questions (10 min. per groups)
  
-  **Fri. 11/3:**  HW 5 - Part 1 Due

-  **Thu. 11/9:**  Quiz 2

-  **Tue. 11/14:**  Final Proposals Due
...
**`5.`** Show me your 2 plots by end of class on Tuesday (if possible)
...
- Submit final script on Blackboard.  This will count towards your class particpation for Week 8.
